$(function () {//TODO 数量加减调用接口
    // 数量减
    // $(".minus").click(function() {
    $(".shopping").delegate(".minus", "click", function () {
    ...
    // 数量加
    // $(".plus").click(function() {
    $(".shopping").delegate(".plus", "click", function () {
        var t = $(this).parent().find('.num');
        t.text(parseInt(t.text()) + 1);
        if (t.text() <= 1) {
            t.text(1);
    ...
    $(".shopping").delegate(".goodsCheck", "click", function () {//使用delegate 动态添加的元素也能有监听事件
    ...
    $(".shopping").delegate(".shopCheck", "click", function () {
